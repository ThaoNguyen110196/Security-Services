...
const CreateEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!DepartmentId) newErrors.BranchId = "DepartmentId is required.";
  ...
  const selectFields = [
    ...
    },
    {
      ...
      options: [
        { value: "", text: "Select Branch" },
        ...departments.map((b) => ({ value: b.Id, text: b.Name })),
      ],
    },
    {
      label: "Country",
            ...
            <div className="sm:col-span-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                {inputFields.map((item, index) => (
                  <label
                    className={`${item.full ? "xl:col-span-2 col-span-1" : "col-span-1"
                      }`}
                    key={index}
                  >
